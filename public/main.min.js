(function(){for(var a=0,b=["ms","moz","webkit","o"],c=0;c<b.length&&!window.requestAnimationFrame;++c)window.requestAnimationFrame=window[b[c]+"RequestAnimationFrame"],window.cancelAnimationFrame=window[b[c]+"CancelAnimationFrame"]||window[b[c]+"CancelRequestAnimationFrame"];window.requestAnimationFrame||(window.requestAnimationFrame=function(b,c){var g=(new Date).getTime(),d=Math.max(0,16-(g-a)),f=window.setTimeout(function(){b(g+d)},d);a=g+d;return f});window.cancelAnimationFrame||(window.cancelAnimationFrame=
function(a){clearTimeout(a)})})();Array.prototype.forEach||(Array.prototype.forEach=function(a,b){var c,h;if(null==this)throw new TypeError(" this is null or not defined");var e=Object(this),g=e.length>>>0;if("function"!==typeof a)throw new TypeError(a+" is not a function");1<arguments.length&&(c=b);for(h=0;h<g;){var d;h in e&&(d=e[h],a.call(c,d,h,e));h++}});
Array.from||(Array.from=function(){var a=Object.prototype.toString,b=function(b){return"function"===typeof b||"[object Function]"===a.call(b)},c=Math.pow(2,53)-1;return function(a){var e=Object(a);if(null==a)throw new TypeError("Array.from requires an array-like object - not null or undefined");var g=1<arguments.length?arguments[1]:void 0,d;if("undefined"!==typeof g){if(!b(g))throw new TypeError("Array.from: when provided, the second argument must be a function");2<arguments.length&&(d=arguments[2])}var f;
f=Number(e.length);f=isNaN(f)?0:0!==f&&isFinite(f)?(0<f?1:-1)*Math.floor(Math.abs(f)):f;f=Math.min(Math.max(f,0),c);for(var m=b(this)?Object(new this(f)):Array(f),k=0,l;k<f;)l=e[k],m[k]=g?"undefined"===typeof d?g(l,k):g.call(d,l,k):l,k+=1;m.length=f;return m}}());Object.keys||(Object.keys=function(){var a=Object.prototype.hasOwnProperty,b=!{toString:null}.propertyIsEnumerable("toString"),c="toString toLocaleString valueOf hasOwnProperty isPrototypeOf propertyIsEnumerable constructor".split(" "),h=c.length;return function(e){if("object"!==typeof e&&("function"!==typeof e||null===e))throw new TypeError("Object.keys called on non-object");var g=[],d;for(d in e)a.call(e,d)&&g.push(d);if(b)for(d=0;d<h;d++)a.call(e,c[d])&&g.push(c[d]);return g}}());var cuiffo=cuiffo||{};cuiffo.math=cuiffo.math||{};cuiffo.math.easeOutQuad=function(a,b,c,h){a/=h;return-c*a*(a-2)+b};cuiffo.math.easeInOutQuad=function(a,b,c,h){a/=h/2;if(1>a)return c/2*a*a+b;a--;return-c/2*(a*(a-2)-1)+b};cuiffo.math.Rect=function(a,b){this.height=a;this.width=b};cuiffo=cuiffo||{};cuiffo.dom=cuiffo.dom||{};cuiffo.dom.getScrollPosition=function(){return document.documentElement.scrollTop||document.body.scrollTop};cuiffo.dom.getWindowHeight=function(){return window.innerHeight};cuiffo.dom.getWindowWidth=function(){return window.innerWidth};cuiffo.dom.getSize=function(a){return new cuiffo.math.Rect(a.clientHeight,a.clientWidth)};
cuiffo.dom.setCssTransform=function(a,b){a.style.webkitTransform=b;a.style.MozTransform=b;a.style.msTransform=b;a.style.OTransform=b;a.style.transform=b};cuiffo.dom.addEventListener=function(a,b,c,h){var e="on"+b;a.addEventListener?a.addEventListener(b,c,h):a.attachEvent(e,c)};cuiffo=cuiffo||{};
